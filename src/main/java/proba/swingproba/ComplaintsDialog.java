...
public class ComplaintsDialog extends JDialog {
    ...
    public ComplaintsDialog(JFrame frame)
    {
        ...
        JPanel panel = new JPanel(new BorderLayout()); // Na ez miert van (BorderLayout) ?
        panel.setLayout(new GridBagLayout()); // <<<----------------------------
        
        // Give the panel a border gap of 5 pixels
        panel.setBorder(new EmptyBorder(new Insets(5, 5, 5, 5)));
        getContentPane().add(BorderLayout.CENTER, panel); // miert kell a BorderLayout-ba a GridBagLayout ???
        ...
        // Add space around all components to avoid clutter (rendetlenseg)
        c.insets = new Insets(2, 2, 2, 2);

        // Anchor all components WEST
        c.anchor = GridBagConstraints.WEST;
        JLabel jLabelShortDescription = new JLabel("Short Description");
        jLabelShortDescription.setBorder(border); // Add some space to the right
        panel.add(jLabelShortDescription, c);
        ...
        jLabelDescription.setBorder(border);

        c.gridwidth = 1;
        c.gridx = 0;
        c.gridy = 1;
        c.weightx = 0.0; // Do not use any extra horizontal space
        panel.add(jLabelDescription, c);
        
        JTextArea area1 = new JTextArea();
        JScrollPane jScrollPane = new JScrollPane( area1) ;
        jScrollPane.setPreferredSize( hugeField) ;
        c.gridx = 1;
        c.weightx = 1.0; // Use all available horizontal space
        ...
        JLabel jLabelSeverity = new JLabel("Severity");
        jLabelSeverity.setBorder(border);
        c.gridx = 0;
        c.gridy = 3;
        c.gridwidth = 1;
        c.gridheight = 1;
        ...
        jLabelPriority.setBorder(border1);
        c.gridx = 2;
        panel.add(jLabelPriority, c);
